...
})(self, (__WEBPACK_EXTERNAL_MODULE__774__, __WEBPACK_EXTERNAL_MODULE__367__) => {
...
/* harmony import */ var vm__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(976);
...
/* harmony import */ var path__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(206);
...
const evaluateScript = (thisParam = null, ast, sb, getFn = false, ...args) => {
  ...
  if (process.env.IS_WEB) {
    __webpack_require__.g.getClosureValue = getClosureValue;
    testResult = eval(testCode);
    delete __webpack_require__.g.getClosureValue;
  } else {
    const contextObject = { ...__webpack_require__.g, getClosureValue };
...
const getCodeFragment = ({ ast, code, sb }) => {
  ...
  if (coverageFnName) {
    ...
    if (process.env.IS_WEB) {
      __webpack_require__.g.getClosureValue = sb.getClosureValue;
      try {
      ...
      const contextObject = {
        ...
        require: __webpack_require__.g.require ? __webpack_require__.g.require : () => {},
      };
    ...
    __webpack_require__.g.__coverage__ = cov;
